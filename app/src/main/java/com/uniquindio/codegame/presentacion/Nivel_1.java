...
public class Nivel_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.toast_nv1,null);
         ...
         */
        hero_00.setVisibility(View.VISIBLE);
        hero_00.playAnimation();
    ...
    public void onClick(View view) {
        ...
        if(sentencias.getText().toString().equals("")){
            Toast.makeText(Nivel_1.this, "Ingresa el Recorrido", Toast.LENGTH_SHORT).show();
        }else{
            restaurar();
            int linea=0;
            int posInicial=0;
            ...
            moverPersonaje(matriz01,posInicial, posInicial2,arrayDirecciones,linea);
            sentencias.setText("");
    ...
    public int moverPersonaje(int matriz[][], int posInicial, int posInicial2, String [] arrayDirecciones, int linea){
        ...
        /** condicion que valida si el personaje se
         * encuentra en la posicion final*/
