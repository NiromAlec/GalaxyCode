...
public class Nivel_3 extends AppCompatActivity {
    ...
    static final String mensaje04="¡Oh no te haz caido en un grieta!";
    Usuario user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.toast_nv3,null);
    ...
    public void onClick(View view) {
        ...
        if(sentencias.getText().toString().equals("")){
            Toast.makeText(Nivel_3.this, "Ingresa el Recorrido", Toast.LENGTH_SHORT).show();
        }else{
            restaurar();
    ...
    public int moverPersonaje(int matriz[][], int posInicial, int posInicial2, String [] arrayDirecciones, int linea){
        ...
        // Movimiento cuando entra en el hielo
        if(matriz[posInicial][posInicial2] == 3) {
            ...
            final int h = posInicial2;
             ...
             int i =posInicial ;
             int j = posInicial2;
            String paso= arrayDirecciones[linea-1];

            if (j >= matriz[0].length && i>=matriz.length) {
                ...
                if(paso.equals("Arriba")){
                    i=i-1;
                }else if(paso.equals("Abajo")){
                    i=i+1;
                }else if(paso.equals("Izquierda")){
                    j=j-1;
                }else{
                    j=j+1;
                }
    ...
    /** Mensaje tutorial sobre el nivel*/
    public void mostrarTutorial3(View view){
        LayoutInflater inflater = getLayoutInflater();
        View layout = inflater.inflate(R.layout.toast_nv3,null);
        Toast toast = new Toast(getApplicationContext());
        toast.setGravity(Gravity.CENTER_VERTICAL, 0, 0);
