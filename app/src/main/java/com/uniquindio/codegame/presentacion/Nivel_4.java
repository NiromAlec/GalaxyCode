...
public class Nivel_4 extends AppCompatActivity {
    ...
    LottieAnimationView delphin;
    LottieAnimationView algas01;
    LottieAnimationView algas02;
    LottieAnimationView algas03;
    ...
    static final String mensaje04="     la corriente del rio \n             te llevó";
    Usuario user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.toast_nv4,null);
        ...
        delphin=findViewById(R.id.delphin);
        delphin.playAnimation();
        algas01=findViewById(R.id.algas);
        algas01.playAnimation();
        algas02=findViewById(R.id.algas2);
        algas02.playAnimation();
        algas03=findViewById(R.id.algas3);
        algas03.playAnimation();
        //FILA(0)
        ...
        hero_03.setVisibility(View.VISIBLE);
        hero_03.playAnimation();
    ...
    public void onClick(View view) {
        ...
        if(sentencias.getText().toString().equals("")){
            Toast.makeText(Nivel_4.this, "Ingresa el Recorrido", Toast.LENGTH_SHORT).show();
        }else{
            restaurar();
    ...
    /** Mensaje tutorial sobre el nivel*/
    public void mostrarTutorial4(View view){
        LayoutInflater inflater = getLayoutInflater();
        View layout = inflater.inflate(R.layout.toast_nv4,null);
        Toast toast = new Toast(getApplicationContext());
        toast.setGravity(Gravity.CENTER_VERTICAL, 0, 0);
