...
public class Nivel_5 extends AppCompatActivity {
    ...
    LottieAnimationView monsterB;
    LottieAnimationView monsterC;
    LottieAnimationView monsterD;
    LottieAnimationView portalA;
    LottieAnimationView portalB;
    ...
    static final String mensaje03="Ganaste!";
    static final String mensaje04="Fuiste capturado!";
    static final String mensaje05="No puedes pisar Lava!";
    static final String mensaje06="     la corriente del rio \n             te llevó";
    Usuario user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.toast_nv5,null);
        ...
        monsterA=findViewById(R.id.monsterA);
        monsterA.playAnimation();
        monsterB=findViewById(R.id.monsterB);
        monsterB.playAnimation();
        monsterC=findViewById(R.id.monsterC);
        monsterC.playAnimation();
        monsterD=findViewById(R.id.monsterD);
        monsterD.playAnimation();

        portalA=findViewById(R.id.portalA);
        portalA.playAnimation();
        portalB=findViewById(R.id.portalB);
        portalB.playAnimation();
         ...
         */
        hero_55.setVisibility(View.VISIBLE);
        hero_55.playAnimation();
    ...
    public void onClick(View view) {
        ...
        if(sentencias.getText().toString().equals("")){
            Toast.makeText(Nivel_5.this, "Ingresa el Recorrido", Toast.LENGTH_SHORT).show();
        }else{
            restaurar();
    ...
    public int moverPersonaje(int matriz[][], int posInicial, int posInicial2, String [] arrayDirecciones, int linea){
                ...
                public void run() {
                    ...
                    handlerr.post(new Runnable() {
                        public void run() {
                            ...
                            casos_uso.lanzarResultados(user);
                ...
                public void run() {
                    ...
                    handlerr.post(new Runnable() {
                        public void run() {
                            ...
                            casos_uso.mostrarVentana(mensaje05,tryAgain,4);
                            restaurar();
                        }
                    });
                }
        ...
        if(matriz[posInicial][posInicial2] == 4) {
            final Handler handlerr = new Handler();
            Timer t2 = new Timer();
            t2.schedule(new TimerTask() {
                public void run() {
        ...
        if(matriz[posInicial][posInicial2] == 5) {
            final Handler handlerr = new Handler();
            Timer t2 = new Timer();
            t2.schedule(new TimerTask() {
                public void run() {
                    ...
                    handlerr.post(new Runnable() {
                        public void run() {
                            ...
                            casos_uso.mostrarVentana(mensaje06,tryAgain,4);
                            restaurar();
                        }
                    });
                }
        ...
        if(matriz[posInicial][posInicial2] == 7) {
            ...
            if (j >= matriz[0].length) {
                ...
                posInicial = i;
                posInicial2 = j;
                return moverPersonaje(matriz, posInicial, posInicial2, arrayDirecciones, linea );
    ...
    /** Mensaje tutorial sobre el nivel*/
    public void mostrarTutorial5(View view){
        LayoutInflater inflater = getLayoutInflater();
        View layout = inflater.inflate(R.layout.toast_nv5,null);
        Toast toast = new Toast(getApplicationContext());
        toast.setGravity(Gravity.CENTER_VERTICAL, 0, 0);
